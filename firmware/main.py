...
keyboard.row_pins = (   
    board.GP22,  # row-1 (top)
    board.GP21,
    board.GP20,
    board.GP19,
    board.GP18,  # row-5 (bottom)   
)
...
keyboard.keymap = [
    ...
    [   # Left FN
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   KC.GRV,  KC.PGUP,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   KC.HOME, KC.PGDOWN, KC.END,
